...
- [3 - Exercício: Isolamento de Classe com Objetos Simulados (Mocks)](#3--isolamento-de-classe-com-objetos-simulados-mocks)
- [4 - Exercício: Testes CRUD com Partição de Equivalência e Análise de Valor Limite](#4--testes-crud-com-partição-de-equivalência-e-análise-de-valor-limit)
---
